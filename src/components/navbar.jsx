          ...
          {isAuthenticated ? (
            <>
              ...
              <button
                ...
                className="bg-red-600 hover:bg-red-700 px-4 py-2 cursor-pointer rounded transition duration-300 font-semibold"
              >
                Logout
              </button>
            </>
        ...
        <div className="md:hidden bg-slate-800 border-t border-slate-700 px-4 py-4 space-y-3">
          ...
          {isAuthenticated ? (
            <>
              ...
              <button
                onClick={handleLogout}
                className="w-full cursor-pointer bg-red-600 hover:bg-red-700 px-4 py-2 rounded transition duration-300 font-semibold text-left"
              >
                Logout
              </button>
            </>
